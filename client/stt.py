...
class GoogleCloudSTT(AbstractSTTEngine):
    ...
    def _get_speech_service(self):
        ...
        return discovery.build(
            'speech', 'v1beta1', developerKey=self.api_key, discoveryServiceUrl=self.DISCOVERY_URL)
    # [END authenticating]
	...
	service_request = service.speech().syncrecognize(body=data)
